...
import { BudgetRange, type Place, PlaceStatus } from "../backend";
...
export default function AddPlaceForm({
  ...
  >(() =>
    extractAttractionsFromPlace(editingPlace).map((v) => ({
  ...
  const addAttraction = () => {
    setAttractions([...attractions, { id: crypto.randomUUID(), value: "" }]);
  };
    ...
    async (files: FileList) => {
      for (let i = 0; i < files.length; i++) {
        ...
        if (file.size > 20 * 1024 * 1024) {
          setUploadMessage({
            type: "error",
            text: "Image must be less than 20MB.",
          });
          setTimeout(() => setUploadMessage(null), 3000);
          continue;
        }
  ...
  const handleDrop = (e: React.DragEvent, dropIndex: number) => {
    ...
    if (draggedIndex === coverImageIndex) {
      ...
      draggedIndex < coverImageIndex &&
      insertIndex >= coverImageIndex
    ) {
      setCoverImageIndex((prev) => prev - 1);
    } else if (
      draggedIndex > coverImageIndex &&
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const rawPlaceData: Place = {
      ...
      author: editingPlace?.author || Principal.anonymous(),
    ...
    try {
      if (isEditing) {
        ...
        setAttractions([{ id: crypto.randomUUID(), value: "" }]);
          ...
          <div className="mobile-modal-body">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="form-field">
                  <label htmlFor="field-state-region" className="form-label">
                    State/Region
                  </label>
                  <input
                    ...
                    type="text"
                    onChange={(e) =>
                      handleFieldChange("stateRegion", e.target.value)
                    }
                    className="form-input"
              ...
              <div className="form-field">
                  ...
                  {attractions.map((attraction, index) => (
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          updateAttraction(index, e.target.value)
                        }
                ...
                <p className="form-help-text">
                  Add specific attractions, landmarks, neighborhoods, or areas
                  within the city. Click + to add more entries.
                </p>
              </div>
                ...
                {selectedStatuses.length > 1 && (
                  <div className="status-selection-feedback">
                    ...
                    <p className="text-xs text-green-600 mt-1">
                      ✅ All selected statuses will be saved and displayed for
                      this place.
                    </p>
                  </div>
                )}
              ...
              <div className="form-field">
                <p className="form-label">Best Time to Visit</p>
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-gray-400 transition-transform ${showMonthPicker ? "rotate-180" : ""}`}
                      />
                    </div>
                  </button>
                  ...
                  {showMonthPicker && (
                    <>
                      ...
                      <div
                        ...
                        onKeyDown={(e) => {
                          if (e.key === "Escape") handleMonthPickerClose();
                        }}
                        role="presentation"
                      />
                            ...
                            {MONTHS.map((month, index) => (
                              ...
                              >
                                <input
                                  ...
                                  onClick={(e) => e.stopPropagation()}
                                />
                                <span className="mobile-month-text">
                                  {month}
                                </span>
                              </label>
                            ))}
                ...
                <p className="form-help-text">
                  Select one or more months when this destination is best to
                  visit. Tap the checkboxes to select/deselect months.
                </p>
              </div>
                    ...
                    {isUploading ? (
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-center space-x-1 text-xs text-blue-600">
                          <span>
                            Images will be automatically sized for consistent
                            display
                          </span>
                        </div>
                      </div>
                        ...
                        <div className="flex items-start space-x-2">
                          ...
                          <div>
                            ...
                            <p className="text-blue-800">
                              The cover photo (marked with ⭐) will be used as
                              the main thumbnail in lists and carousels. Drag
                              images to reorder them in the gallery. All images
                              are automatically sized for consistent display.
                            </p>
                            <p className="text-blue-800 mt-2 font-medium">
                              ✅ You can select a cover photo and continue
                              editing all other fields - changes are only saved
              ...
              <div className="space-y-4">
                ...
                <div className="form-field">
                  <label htmlFor="field-best-known" className="form-label">
                    Best Known For
                  </label>
                  <input
                    id="field-best-known"
                    ...
                    onChange={(e) =>
                      handleFieldChange("bestKnownFor", e.target.value)
                    }
                    className="form-input"
                ...
                <div className="form-field">
                  <label htmlFor="field-hidden-gem" className="form-label">
                    Hidden Gem
                  </label>
                  <input
                    id="field-hidden-gem"
                    ...
                    onChange={(e) =>
                      handleFieldChange("hiddenGem", e.target.value)
                    }
                    className="form-input"
                ...
                <div className="form-field">
                  <label htmlFor="field-local-tip" className="form-label">
                    Local Tip
                  </label>
                  <input
                    id="field-local-tip"
                    ...
                    onChange={(e) =>
                      handleFieldChange("localTip", e.target.value)
                    }
                    className="form-input"
              ...
              <div className="form-field">
                ...
                />
                <p className="form-help-text">
                  Separate tags with commas. Tags will be automatically
...
function DraggablePhotoThumbnail({
  ...
  return (
    ...
    >
      ...
      {/* Cover Badge */}
      {isCover && <div className="photo-thumbnail-cover-badge">Cover</div>}

      {/* Order Number */}
      <div className="photo-thumbnail-order-number">#{index + 1}</div>
    </div>
  );
}
