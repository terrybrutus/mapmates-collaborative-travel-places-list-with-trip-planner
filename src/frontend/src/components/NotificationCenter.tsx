...
export default function NotificationCenter() {
  ...
  const [filterType, setFilterType] = useState<"all" | "unread" | "place">(
    "all",
  );
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      title: "Place updated",
      message:
        'Mike updated details for "Tokyo, Japan" with new photos and tips',
    ...
    switch (filterType) {
      ...
      case "place":
        filtered = filtered.filter(
          (n) => n.type === "place_added" || n.type === "place_edited",
        );
        break;
    }
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Get notified when places are added or edited
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        updateSetting("placeUpdates", e.target.checked)
                      }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        updateSetting("collaborationInvites", e.target.checked)
                      }
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600" />
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      <li>
                        • Notifications help you stay updated on collaborative
                        activities
                      </li>
                      <li>
                        • You can always adjust these settings based on your
                        preferences
                      </li>
                      <li>
                        • Important notifications (like collaboration invites)
                        are always shown
                      </li>
                    </ul>
                  </div>
