...
`;
      ...
      setExportMessage({
        type: "success",
        message:
          "TXT file exported successfully with round-trip compatibility!",
      });
    } catch (error) {
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">
              {
                places.filter((p) => p.status.includes(PlaceStatus.researched))
                  .length
              }
            </div>
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-yellow-600">
              {
                places.filter((p) => p.status.includes(PlaceStatus.toResearch))
                  .length
              }
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Round-trip compatible format for re-importing
              </p>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              <li>
                • Block-based format with <code>|| </code> prefix
              </li>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm">
                ...
                <p className="text-green-800">
                  This export format matches the import format exactly. You can
                  import this file back to recreate the same places with all
                  their data intact.
                </p>
              </div>
            </div>
      ...
      {places.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">
            Add some places to your list before exporting.
          </p>
        </div>
      )}
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>
                • <strong>Block Format TXT:</strong> Uses the exact same format
                as import for perfect round-trip compatibility
              </li>
              <li>
                • <strong>CSV Format:</strong> Structured data ideal for
                spreadsheet analysis and data processing
              </li>
              <li>
                • Files are generated and downloaded directly to your device
              </li>
              <li>
                • All place data including notes, tags, and metadata is included
              </li>
              <li>
                • Export files are named with the current date for easy
                organization
              </li>
